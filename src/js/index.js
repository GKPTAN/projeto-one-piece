...
const botoes = document.querySelectorAll('.botao, .botao2');
...
function desselecionarbotao2() {
    const botao2Selecionado = document.querySelector(".botao2.selecionado");
    botao2Selecionado.classList.remove("selecionado");
}
